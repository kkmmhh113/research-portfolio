...
융합생명공학을 전공하고 있지만 파이썬을 활용한 데이터분석과 인공지능의 이해 등의 수업을 듣는 등 인공지능과 computational biology에 대해 지속적으로 관심을 가져왔으며 ai의 발전으로 코드 구현에 대한 장벽이 낮아지며 본격적으로 바이오 ai에 대해 관심을 가지고 공부하기 시작했습니다.
현재는 분자 구조를 이용한 약물 반응 예측과 조직별 모델을 연결하는 인체 디지털 트윈 등 바이오데이터를 활용해 치료와 연구에 도움이 될 인공지능 모델을 설계하는 것에 큰 관심을 가지고 있습니다.
